...
!(function(t) {
		...
		i('inspectSource', function(t) {
			...
			(t.exports = function(t, e, n, i) {
				var l = !!i && !!i.unsafe,
					u = !!i && !!i.enumerable,
					c = !!i && !!i.noTargetGet;
				'function' == typeof n && ('string' != typeof e || a(n, 'name') || o(n, 'name', e), (d(n).source = f.join('string' == typeof e ? e : ''))),
		...
		var r = n(7),
			...
			d = function() {
				var t,
					...
					n = o.length;
				for (
					e.style.display = 'none', s.appendChild(e), e.src = String('javascript:'), (t = e.contentWindow.document).open(), t.write('<script>document.F=Object</script>'), t.close(), d = t.F;
					n--;
	...
	function(t, e, n) {
		...
		t.exports = function(t, e, n, c, h, y, b) {
			...
			if (
				(T && ((x = o(T.call(new t()))), p !== Object.prototype && x.next && (d || o(x) === p || (a ? a(x, p) : 'function' != typeof x[v] && l(x, v, m)), s(x, C, !0, !0), d && (f[C] = m))),
				'values' == h &&
					P &&
					'values' !== P.name &&
					((M = !0),
				...
				return function(e, n) {
					...
					return l < 0 || l >= u
						...
						: (o = s.charCodeAt(l)) < 55296 || o > 56319 || l + 1 === u || (a = s.charCodeAt(l + 1)) < 56320 || a > 57343
							? t ? s.charAt(l) : o
							: t ? s.slice(l, l + 2) : a - 56320 + ((o - 55296) << 10) + 65536;
				};
			};
		t.exports = {
			codeAt : o(!1),
		...
		r(
			...
			},
			{
				slice : function(t, e) {
					...
					if (
						o(p) &&
						('function' != typeof (n = p.constructor) || (n !== Array && !o(n.prototype)) ? i(n) && null === (n = n[d]) && (n = void 0) : (n = void 0), n === Array || void 0 === n)
					)
						return f.call(p, v, m);
			...
			},
			{
				splice : function(t, e) {
					var n,
						...
						y = i(t, m),
						b = arguments.length;
					if ((0 === b ? (n = r = 0) : 1 === b ? ((n = 0), (r = m - y)) : ((n = b - 2), (r = f(d(o(e), 0), m - y))), m + n - r > 9007199254740991))
						...
						''.split(/.?/).length
							? function(t, n) {
									...
									for (
										...
										!(
											(l = g.lastIndex) > p &&
											(c.push(r.slice(p, s.index)), s.length > 1 && s.index < r.length && h.apply(c, s.slice(1)), (u = s[0].length), (p = l), c.length >= o)
										);
		...
		!(function(t) {
			...
			t(r).each(function(e, n) {
				...
				t(document).on('reset', function(e) {
					var n = t(e.target);
					n.is('form') &&
						(n.find(r).removeClass('valid').removeClass('invalid').each(function(e, n) {
							var r = t(n),
								i = !r.val(),
							...
							e.find('.nested').hide(),
								...
								r.on('click', function() {
									...
									e.toggleClass('open'),
										...
										n.hasClass('active') ? n.removeClass('active').slideUp() : n.addClass('active').slideDown();
								}),
								n.off('click'),
								n.on('click', function() {
									var e = t(this);
							...
							},
							{
								...
								value : function() {
									var t = 1e3 * this.$wowElement.css('animation-duration').slice(0, -1),
										e = 0;
									return (
										this.options.duration && (e = t + this.checkOptionsStringFormat(this.options.duration)),
										this.options.delay && (e += this.checkOptionsStringFormat(this.options.delay)),
										e
									);
								}
							},
				...
				for (
					(t = M(t)) != t || t === 1 / 0
						...
						: ((r = P(_(t) / T)),
							...
							r + u >= l ? ((i = 0), (r = l)) : r + u >= 1 ? ((i = (t * o - 1) * A(2, e)), (r += u)) : ((i = t * A(2, u - 1) * A(2, e)), (r = 0)));
					e >= 8;
					a[f++] = 255 & i, i /= 256, e -= 8
				);
         ...
         */
			(e = void 0),
				...
				'object' === ('undefined' == typeof exports ? 'undefined' : i(exports)) && void 0 !== t
					? (t.exports = r())
					: 'function' == typeof define && n(55) ? define(r) : ((e = e || self).bsCustomFileInput = r()),
											...
											: this instanceof t
												? ((this.valid = !1),
													...
													void ('string' == typeof e
														? (n = i.getRgba(e)) ? this.setValues('rgb', n) : (n = i.getHsla(e)) ? this.setValues('hsl', n) : (n = i.getHwb(e)) && this.setValues('hwb', n)
														: 'object' === o(e) &&
																...
																: void 0 !== n.l || void 0 !== n.lightness
																	...
																	: void 0 !== n.v || void 0 !== n.value
																		...
																		: void 0 !== n.w || void 0 !== n.whiteness
																			...
																			: (void 0 === n.c && void 0 === n.cyan) || this.setValues('cmyk', n))))
												: new t(e);
										var n;
									};
								((a.prototype = {
										...
										for (var o in r)
											r.hasOwnProperty(o) &&
												...
												'[object Array]' === (e = {}.toString.call(t))
													? (i[o] = t.slice(0))
													: '[object Number]' === e ? (i[o] = t) : console.error('unexpected color value:', t));
										return n;
									}
								}).spaces = {
									rgb  : [ 'red', 'green', 'blue' ],
							...
							function(t, e, n) {
								function i(t) {
									var e,
										...
										l = s - a;
									return (
										s == a ? (e = 0) : r == s ? (e = (i - o) / l) : i == s ? (e = 2 + (o - r) / l) : o == s && (e = 4 + (r - i) / l),
								...
								function v(t) {
									...
									return (
										...
										(e = (e = 3.2406 * i + -1.5372 * o + -0.4986 * a) > 0.0031308 ? 1.055 * Math.pow(e, 1 / 2.4) - 0.055 : (e *= 12.92)),
								...
								function y(t) {
									var e,
										...
										s = t[2];
									return (
										o <= 8 ? (i = (n = 100 * o / 903.3) / 100 * 7.787 + 16 / 116) : ((n = 100 * Math.pow((o + 16) / 116, 3)), (i = Math.pow(n / 100, 1 / 3))),
										[
											...
											_getStacks              : function(t) {
												...
												for (e = 0; e < o; ++e)
													(n = r.getDatasetMeta(e)).bar &&
														...
														(!1 === i || (!0 === i && -1 === a.indexOf(n.stack)) || (void 0 === i && (void 0 === n.stack || -1 === a.indexOf(n.stack)))) &&
														a.push(n.stack);
												return a;
											},
												...
												if (h || (void 0 === h && void 0 !== p))
													for (n = 0; n < t; ++n)
														(r = l.getDatasetMeta(n)).bar &&
															...
															((i = c.getRightValue(d[n].data[e])), ((f < 0 && i < 0) || (f >= 0 && i > 0)) && (g += i));
												return (
														...
														'flex' === r.barThickness
															...
															: (function(t, e, n) {
																	var r,
																		...
																		l = e.pixels[t];
																	return (
																		o.isNullOrUndef(a) ? ((r = e.min * n.categoryPercentage), (i = n.barPercentage)) : ((r = a * s), (i = 1)),
																		{
																			chunk : r / s,
																			ratio : i,
																			start : l - r / 2
										...
										t.controllers.bubble = t.DatasetController.extend({
											...
											updateElement          : function(t, e, n) {
												var r = this,
													...
													d = r.index,
													f = n ? s.getPixelForDecimal(0.5) : s.getPixelForValue('object' === o(c) ? c : NaN, e, d),
											...
											setHoverStyle          : function(t) {
												...
												(t.$previousStyle = {
													...
													(e.backgroundColor = a.valueOrDefault(n.hoverBackgroundColor, a.getHoverColor(n.backgroundColor))),
													(e.borderColor = a.valueOrDefault(n.hoverBorderColor, a.getHoverColor(n.borderColor))),
													(e.borderWidth = a.valueOrDefault(n.hoverBorderWidth, n.borderWidth)),
									...
									(e.exports = function(t) {
										t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend({
											...
											updateElement          : function(t, e, n) {
												...
												(y.backgroundColor = b.backgroundColor ? b.backgroundColor : x(h.backgroundColor, e, w.backgroundColor)),
													(y.borderColor = b.borderColor ? b.borderColor : x(h.borderColor, e, w.borderColor)),
													(y.borderWidth = b.borderWidth ? b.borderWidth : x(h.borderWidth, e, w.borderWidth)),
													(n && l.animateRotate) ||
														((y.startAngle = 0 === e ? s.rotation : r.getMeta().data[e - 1]._model.endAngle), (y.endAngle = y.startAngle + y.circumference)),
													t.pivot();
											},
											...
											getMaxBorderWidth      : function(t) {
												for (var e, n, r = 0, i = this.index, o = t.length, a = 0; a < o; a++)
													(e = t[a]._model ? t[a]._model.borderWidth : 0),
														(r = (n = t[a]._chart ? t[a]._chart.config.data.datasets[i].hoverBorderWidth : 0) > (r = e > r ? e : r) ? n : r);
												return r;
											}
										});
									});
										...
										t.controllers.line = t.DatasetController.extend({
													...
													p &&
														...
														(l._model = {
															...
															cubicInterpolationMode : i.cubicInterpolationMode
																...
																: a.valueOrDefault(h.cubicInterpolationMode, d.cubicInterpolationMode)
														}),
														l.pivot()),
														n = 0,
														r = u.length;
											...
											getPointBackgroundColor   : function(t, e) {
												...
												return (
													i.backgroundColor
														? (n = i.backgroundColor)
														: r.pointBackgroundColor ? (n = a.valueAtIndexOrDefault(r.pointBackgroundColor, e, n)) : r.backgroundColor && (n = r.backgroundColor),
													n
												);
											},
											getPointBorderColor       : function(t, e) {
												...
												return (
													i.borderColor
														? (n = i.borderColor)
														: r.pointBorderColor ? (n = a.valueAtIndexOrDefault(r.pointBorderColor, e, n)) : r.borderColor && (n = r.borderColor),
													n
												);
											},
											...
											getPointRotation          : function(t, e) {
												...
												return (
													isNaN(i.rotation)
														? (isNaN(r.pointRotation) && !a.isArray(r.pointRotation)) || (n = a.valueAtIndexOrDefault(r.pointRotation, e, n))
														: (n = i.rotation),
													n
												);
											},
											...
											updateBezierControlPoints : function() {
												...
												if (
													...
													for (t = 0, e = s.length; t < e; ++t)
														(n = s[t]._model),
															(r = a.splineCurve(a.previousItem(s, t)._model, n, a.nextItem(s, t)._model, i.dataset._model.tension)),
												...
												if (this.chart.options.elements.line.capBezierPoints)
													for (t = 0, e = s.length; t < e; ++t)
														((n = s[t]._model).controlPointPreviousX = l(n.controlPointPreviousX, o.left, o.right)),
											...
											setHoverStyle             : function(t) {
												...
												(t.$previousStyle = {
													...
													(i.backgroundColor = r.hoverBackgroundColor || a.valueAtIndexOrDefault(e.pointHoverBackgroundColor, n, a.getHoverColor(i.backgroundColor))),
													(i.borderColor = r.hoverBorderColor || a.valueAtIndexOrDefault(e.pointHoverBorderColor, n, a.getHoverColor(i.borderColor))),
													(i.borderWidth = r.hoverBorderWidth || a.valueAtIndexOrDefault(e.pointHoverBorderWidth, n, i.borderWidth)),
													(i.radius = r.hoverRadius || a.valueAtIndexOrDefault(e.pointHoverRadius, n, this.chart.options.elements.point.hoverRadius));
											}
										});
									});
							},
										...
										t.controllers.polarArea = t.DatasetController.extend({
											...
											updateElement        : function(t, e, n) {
												...
												var y = this.chart.options.elements.arc,
													...
													x = o.valueAtIndexOrDefault,
													w = t._model;
												(w.backgroundColor = b.backgroundColor ? b.backgroundColor : x(a.backgroundColor, e, y.backgroundColor)),
													(w.borderColor = b.borderColor ? b.borderColor : x(a.borderColor, e, y.borderColor)),
													(w.borderWidth = b.borderWidth ? b.borderWidth : x(a.borderWidth, e, y.borderWidth)),
													t.pivot();
											},
										...
										t.controllers.radar = t.DatasetController.extend({
											...
											updateBezierControlPoints : function() {
												...
												o.each(e.data, function(n, r) {
													...
													(i.controlPointPreviousX = Math.max(Math.min(a.previous.x, t.right), t.left)),
														(i.controlPointPreviousY = Math.max(Math.min(a.previous.y, t.bottom), t.top)),
														(i.controlPointNextX = Math.max(Math.min(a.next.x, t.right), t.left)),
														(i.controlPointNextY = Math.max(Math.min(a.next.y, t.bottom), t.top)),
														n.pivot();
												});
											},
											setHoverStyle             : function(t) {
												...
												(t.$previousStyle = {
													...
													(i.radius = n.hoverRadius ? n.hoverRadius : o.valueAtIndexOrDefault(e.pointHoverRadius, r, this.chart.options.elements.point.hoverRadius)),
													(i.backgroundColor = n.hoverBackgroundColor
														? n.hoverBackgroundColor
														: o.valueAtIndexOrDefault(e.pointHoverBackgroundColor, r, o.getHoverColor(i.backgroundColor))),
													(i.borderColor = n.hoverBorderColor ? n.hoverBorderColor : o.valueAtIndexOrDefault(e.pointHoverBorderColor, r, o.getHoverColor(i.borderColor))),
													(i.borderWidth = n.hoverBorderWidth ? n.hoverBorderWidth : o.valueAtIndexOrDefault(e.pointHoverBorderWidth, r, i.borderWidth));
											}
										});
									});
							},
										...
										advance               : function(t) {
											for (var e, n, r = this.animations, o = 0; o < r.length; )
												(n = (e = r[o]).chart),
													...
													e.currentStep >= e.numSteps ? (i.callback(e.onAnimationComplete, [ e ], n), (n.animating = !1), r.splice(o, 1)) : ++o;
										}
									});
							},
							{
									...
									(t.types = {}),
										...
										s.extend(t.prototype, {
												...
												return (
													s.each(
														...
														function(i, o) {
															...
															if ((a.type && a.type !== s && (e.destroyDatasetMeta(o), (a = e.getDatasetMeta(o))), (a.type = s), n.push(a.type), a.controller))
											...
											destroy                   : function() {
												...
												i && (r.unbindEvents(), s.canvas.clear(r), c.releaseContext(r.ctx), (r.canvas = null), (r.ctx = null)),
													d.notify(r, 'destroy'),
											...
											handleEvent               : function(t) {
												...
												return (
													...
													'mouseout' === t.type ? (n.active = []) : (n.active = n.getElementsAtEventForMode(t, i.mode, i)),
													s.callback(r.onHover || r.hover.onHover, [ t.native, n.active ], n),
													('mouseup' !== t.type && 'click' !== t.type) || (r.onClick && r.onClick.call(n, t.native, n.active)),
										...
										r.extend(t.DatasetController.prototype, {
											...
											setHoverStyle         : function(t) {
												...
												(t.$previousStyle = {
													...
													(s.backgroundColor = i.hoverBackgroundColor ? i.hoverBackgroundColor : o(e.hoverBackgroundColor, n, a(s.backgroundColor))),
													(s.borderColor = i.hoverBorderColor ? i.hoverBorderColor : o(e.hoverBorderColor, n, a(s.borderColor))),
													(s.borderWidth = i.hoverBorderWidth ? i.hoverBorderWidth : o(e.hoverBorderWidth, n, s.borderWidth));
											},
												...
												merger : function(t, e, n, r) {
													if ('xAxes' === t || 'yAxes' === t) {
														...
														for (e[t] || (e[t] = []), i = 0; i < u; ++i)
															(l = n[t][i]),
																(s = o.valueOrDefault(l.type, 'xAxes' === t ? 'category' : 'linear')),
																i >= e[t].length && e[t].push({}),
																!e[t][i].type || (l.type && l.type !== e[t][i].type) ? o.merge(e[t][i], [ a.getScaleDefaults(s), l ]) : o.merge(e[t][i], l);
										...
										(o.splineCurveMonotone = function(t) {
											...
											for (e = 0; e < f; ++e)
												if (!(r = d[e]).model.skip) {
													...
													!n || n.model.skip
														? (r.mK = r.deltaK)
														: !i || i.model.skip ? (r.mK = n.deltaK) : this.sign(n.deltaK) !== this.sign(r.deltaK) ? (r.mK = 0) : (r.mK = (n.deltaK + r.deltaK) / 2);
												}
											for (e = 0; e < f - 1; ++e)
												(r = d[e]),
													(i = d[e + 1]),
													r.model.skip ||
														...
														(o.almostEquals(r.deltaK, 0, this.EPSILON)
															...
															: ((a = r.mK / r.deltaK),
																(s = i.mK / r.deltaK),
																(u = Math.pow(a, 2) + Math.pow(s, 2)) <= 9 || ((l = 3 / Math.sqrt(u)), (r.mK = a * l * r.deltaK), (i.mK = s * l * r.deltaK))));
											for (e = 0; e < f; ++e)
												(r = d[e]).model.skip ||
													((n = e > 0 ? d[e - 1] : null),
													(i = e < f - 1 ? d[e + 1] : null),
													n &&
														!n.model.skip &&
														((c = (r.model.x - n.model.x) / 3), (r.model.controlPointPreviousX = r.model.x - c), (r.model.controlPointPreviousY = r.model.y - c * r.mK)),
													i &&
														!i.model.skip &&
														((c = (i.model.x - r.model.x) / 3), (r.model.controlPointNextX = r.model.x + c), (r.model.controlPointNextY = r.model.y + c * r.mK)));
										}),
									...
									update    : function(t, e, n) {
										if (t) {
											...
											r.each(f.concat(h, p, g), function(t) {
												var e,
													n = t.isHorizontal();
												n ? ((e = t.update(t.fullWidth ? m : S, w)), (k -= e.height)) : ((e = t.update(x, k)), (S -= e.width)),
													C.push({
														horizontal : n,
														minSize    : e,
														box        : t
										...
										function B(t) {
											t.isHorizontal()
												? ((t.left = t.fullWidth ? l : T), (t.right = t.fullWidth ? e - u : T + S), (t.top = V), (t.bottom = V + t.height), (V = t.bottom))
												: ((t.left = N), (t.right = N + t.width), (t.top = O), (t.bottom = O + k), (N = t.right));
										}
									}
								};
							},
									...
									(e.exports = i.extend({
										...
										calculateTickRotation       : function() {
											...
											if (r.length && t.options.display && t.isHorizontal())
												for (
													var l, u = o.longestText(e, i.font, r, t.longestTextCache), d = u, f = t.getPixelForTick(1) - t.getPixelForTick(0) - 6;
													d > f && a < n.maxRotation;
										...
										fit                         : function() {
											...
											if (
												((e.width = h ? (t.isFullWidth() ? t.maxWidth - t.margins.left - t.margins.right : t.maxWidth) : f && l.drawTicks ? g : 0),
											...
											if (i.display && f) {
												...
												if (h) {
													...
													0 !== t.labelRotation
														? ((t.paddingLeft = 'bottom' === r.position ? S * C + 3 : S * b + 3), (t.paddingRight = 'bottom' === r.position ? S * b + 3 : S * M + 3))
										...
										_autoSkip                   : function(t) {
											...
											for (
												l.maxTicksLimit && (i = l.maxTicksLimit),
													s &&
														((e = !1),
														(f + l.autoSkipPadding) * u > a.width - (a.paddingLeft + a.paddingRight) &&
															(e = 1 + Math.floor((f + l.autoSkipPadding) * u / (a.width - (a.paddingLeft + a.paddingRight)))),
										...
										draw                        : function(t) {
											...
											if (n.display) {
													...
													(o.each(v, function(r, i) {
														if (!o.isNullOrUndef(r.label)) {
															...
															i === e.zeroLineIndex && n.offset === f.offsetGridLines
																? ((u = f.zeroLineWidth), (c = f.zeroLineColor), (d = f.zeroLineBorderDash), (h = f.zeroLineBorderDashOffset))
																: ((u = o.valueAtIndexOrDefault(f.lineWidth, i)),
																	(c = o.valueAtIndexOrDefault(f.color, i)),
																	(d = o.valueOrDefault(f.borderDash, a.borderDash)),
																	(h = o.valueOrDefault(f.borderDashOffset, a.borderDashOffset)));
															var R = 'middle',
																N = 'middle',
																V = s.padding;
															if (g) {
																var z = w + V;
																'bottom' === n.position
																	? ((N = p ? 'middle' : 'top'), (R = p ? 'right' : 'center'), (E = e.top + z))
																	: ((N = p ? 'middle' : 'bottom'), (R = p ? 'left' : 'center'), (E = e.bottom - z));
													...
													o.each(A, function(t) {
														if (
															(f.display &&
																...
																i.setLineDash && (i.setLineDash(t.glBorderDash), (i.lineDashOffset = t.glBorderDashOffset)),
																i.beginPath(),
																f.drawTicks && (i.moveTo(t.tx1, t.ty1), i.lineTo(t.tx2, t.ty2)),
																f.drawOnChartArea && (i.moveTo(t.x1, t.y1), i.lineTo(t.x2, t.y2)),
																i.stroke(),
																i.restore()),
															s.display)
														) {
															...
															var n = t.label;
															if (o.isArray(n))
																for (var r = n.length, a = 1.5 * y.size, l = e.isHorizontal() ? 0 : -a * (r - 1) / 2, u = 0; u < r; ++u)
												...
												if (f.drawBorder) {
													...
													g
														? ((z = B = 'top' === n.position ? e.bottom : e.top), (z += W), (B += W))
														: ((N = V = 'left' === n.position ? e.right : e.left), (N += W), (V += W)),
														i.beginPath(),
														i.moveTo(N, z),
														i.lineTo(V, B),
														i.stroke();
								...
								(e.exports = i.extend({
											...
											f.filter &&
												...
												(b = (function(t, e) {
													...
													return (
														...
														(h = 0),
														(n.font = o.fontString(f, e._footerFontStyle, e._footerFontFamily)),
														o.each(e.footer, p),
														{
												...
												(y = (function(t, e, n, r) {
													var i = t.x,
														...
														f = l + s;
													return (
														'right' === u ? (i -= e.width) : 'center' === u && ((i -= e.width / 2) + e.width > r.width && (i = r.width - e.width), i < 0 && (i = 0)),
														'top' === c ? (o += d) : (o -= 'bottom' === c ? e.height + d : e.height / 2),
														'center' === c ? ('left' === u ? (i += d) : 'right' === u && (i -= d)) : 'left' === u ? (i -= f) : 'right' === u && (i += f),
														{
															x : i,
															y : o
														}
									...
									getCaretPosition : function(t, e, n) {
										var r,
											...
											v = e.height;
										if ('center' === f)
											(s = p + v / 2), 'left' === d ? ((i = (r = h) - u), (o = r), (a = s + u), (l = s - u)) : ((i = (r = h + g) + u), (o = r), (a = s - u), (l = s + u));
										else if (
											('left' === d
												? ((r = (i = h + c + u) - u), (o = i + u))
												: 'right' === d ? ((r = (i = h + g - c - u) - u), (o = i + u)) : ((r = (i = n.caretX) - u), (o = i + u)),
											'top' === f)
										)
											(s = (a = p) - u), (l = a);
										else {
									...
									drawFooter       : function(t, e, n, r) {
										...
										i.length &&
											...
											(n.font = o.fontString(e.footerFontSize, e._footerFontStyle, e._footerFontFamily)),
											o.each(i, function(r) {
									...
									handleEvent      : function(t) {
										...
										return (
											...
											'mouseout' === t.type ? (n._active = []) : (n._active = n._chart.getElementsAtEventForMode(t, r.mode, r)),
											...
											for (
												...
												(e = u[t]),
													...
													0 === t
														...
														: ((n = -1 === d ? n : u[d]), r.skip || ((d !== t - 1 && !l) || -1 === d ? s.moveTo(r.x, r.y) : o.canvas.lineTo(s, n._view, e._view), (d = t)));
											s.stroke(), s.restore();
										}
									}));
							},
										...
										draw            : function(t) {
											...
											e.skip ||
												((void 0 === t || (n.x >= t.left && 1.01 * t.right >= n.x && n.y >= t.top && 1.01 * t.bottom >= n.y)) &&
													...
													(i.lineWidth = o.valueOrDefault(e.borderWidth, r.global.elements.point.borderWidth)),
								...
								r._set('global', {
									...
									(e.exports = i.extend({
										draw            : function() {
											...
											if (
												(l.horizontal
													? ((t = l.base), (e = l.x), (n = l.y - l.height / 2), (r = l.y + l.height / 2), (i = e > t ? 1 : -1), (o = 1), (a = l.borderSkipped || 'left'))
													: ((t = l.x - l.width / 2), (e = l.x + l.width / 2), (n = l.y), (i = 1), (o = (r = l.base) > n ? 1 : -1), (a = l.borderSkipped || 'bottom')),
												u)
											) {
							...
							function(t, e, n) {
								...
								n = e.exports = {
									...
									lineTo      : function(t, e, n, r) {
										if (n.steppedLine)
											return ('after' === n.steppedLine && !r) || ('after' !== n.steppedLine && r) ? t.lineTo(e.x, n.y) : t.lineTo(n.x, e.y), void t.lineTo(n.x, n.y);
										n.tension
											? t.bezierCurveTo(
								...
								var r,
									i = {
										...
										each                  : function(t, e, n, r) {
											var o, a, s;
											if (i.isArray(t))
												if (((a = t.length), r)) for (o = a - 1; o >= 0; o--) e.call(n, t[o], o);
												...
												: 2 == (t /= 0.5)
													...
													: (n || (n = 0.45),
														...
														t < 1
															...
															: r * Math.pow(2, -10 * (t -= 1)) * Math.sin((t - e) * (2 * Math.PI) / n) * 0.5 + 1);
										},
							...
							function(t, e, n) {
								...
								e.exports = {
									...
									toPadding    : function(t) {
										var e, n, i, o;
										return (
											r.isObject(t) ? ((e = +t.top || 0), (n = +t.right || 0), (i = +t.bottom || 0), (o = +t.left || 0)) : (e = n = i = o = +t || 0),
											{
												top    : e,
												right  : n,
												bottom : i,
							...
							function(t, e, n) {
								...
								(e.exports = {
									...
									initialize          : function() {
										...
										(e = '@-webkit-keyframes ' + s + '{' + r + '}@keyframes ' + s + '{' + r + '}.' + a + '{-webkit-animation:' + s + ' 0.001s;animation:' + s + ' 0.001s;}'),
									...
									if (
										('start' === i
											...
											: 'end' === i
												...
												: void 0 !== n.scaleZero ? (o = n.scaleZero) : r.getBasePosition ? (o = r.getBasePosition()) : r.getBasePixel && (o = r.getBasePixel()),
										null != o)
									) {
													...
													for (t.beginPath(), a = 0, s = g + !!o; a < s; ++a)
														(c = n((u = e[(l = a % g)]._view), l, r)),
															...
															h && p
																...
																: b && x && (v ? (h && m.push(u), p && y.push(c)) : (f(t, m, y, b, x), (b = x = 0), (m = []), (y = [])));
											...
											if (((a.font = h), v)) {
												...
												(a.textAlign = 'left'),
													...
													o.each(t.legendItems, function(e, r) {
														...
														m[m.length - 1] + i + n.padding >= t.width && ((y += c + n.padding), (m[m.length] = t.left)),
															(p[r] = {
																left   : 0,
																top    : 0,
																width  : i,
												...
												o.each(t.legendItems, function(t, e) {
													...
													k + C > g.height && ((w += S + n.padding), x.push(S), (S = 0), (k = 0)),
														(S = Math.max(S, r)),
														(k += C),
														(p[e] = {
															left   : 0,
										...
										if (e.display) {
											...
											o.each(t.legendItems, function(r, l) {
												var h = d.measureText(r.text).width,
													...
													m = c.y;
												x
													? v + g >= s && ((m = c.y += w), c.line++, (v = c.x = t.left + (s - u[c.line]) / 2))
													: m + w > t.bottom && ((v = c.x = v + t.columnWidths[c.line] + n.padding), (m = c.y = t.top + n.padding), c.line++),
													(function(t, n, r) {
														if (!(isNaN(y) || y <= 0)) {
															d.save(),
																(d.fillStyle = f(r.fillStyle, i.defaultColor)),
																(d.lineCap = f(r.lineCap, a.borderCapStyle)),
																(d.lineDashOffset = f(r.lineDashOffset, a.borderDashOffset)),
										...
										if (i.display) {
											...
											(e.fillStyle = n(i.fontColor, a.defaultFontColor)),
												...
												t.isHorizontal()
													...
													: ((l = 'left' === i.position ? y + g : x - g), (u = m + (b - m) / 2), (s = b - m), (v = Math.PI * ('left' === i.position ? -0.5 : 0.5))),
												e.save(),
												e.translate(l, u),
												e.rotate(v),
												(e.textAlign = 'center'),
													...
													i.each(r, function(r, o) {
														...
														n.isDatasetVisible(o) &&
															...
															i.each(r.data, function(n, r) {
																...
																isNaN(i) ||
																	s.data[r].hidden ||
																	((c[r] = c[r] || 0), (d[r] = d[r] || 0), e.relativePoints ? (c[r] = 100) : i < 0 ? (d[r] += i) : (c[r] += i));
															});
													}),
														i.each(l, function(e) {
													...
													i.each(r, function(e, r) {
														...
														n.isDatasetVisible(r) &&
															...
															i.each(e.data, function(e, n) {
																...
																isNaN(r) ||
																	o.data[n].hidden ||
																	(null === t.min ? (t.min = r) : r < t.min && (t.min = r), null === t.max ? (t.max = r) : r > t.max && (t.max = r));
															});
													});
											...
											var t = this,
												...
												o = (t.ticks = (function(t, e) {
													...
													r.isNullOrUndef(t.min) ||
														...
														!t.stepSize ||
														(r.almostWhole((t.max - t.min) / t.stepSize, o / 1e3) && ((l = t.min), (u = t.max)));
													var c = (u - l) / o;
													(c = r.almostEquals(c, Math.round(c), o / 1e3) ? Math.round(c) : Math.ceil(c)),
														(i = 1),
														o < 1 && ((i = Math.pow(10, 1 - Math.floor(r.log10(o)))), (l = Math.round(l * i) / i), (u = Math.round(u * i) / i)),
										...
										n = i.extend({
											...
											handleTickRangeOptions : function() {
												...
												(t.min = n(e.min, t.min)),
													...
													t.min === t.max &&
														(0 !== t.min && null !== t.min
															? ((t.min = Math.pow(10, Math.floor(r.log10(t.min)) - 1)), (t.max = Math.pow(10, Math.floor(r.log10(t.max)) + 1)))
															: ((t.min = 1), (t.max = 10))),
													null === t.min && (t.min = Math.pow(10, Math.floor(r.log10(t.max)) - 1)),
													null === t.max && (t.max = 0 !== t.min ? Math.pow(10, Math.floor(r.log10(t.min)) + 1) : 10),
													null === t.minNotZero &&
														(t.min > 0 ? (t.minNotZero = t.min) : t.max < 1 ? (t.minNotZero = Math.pow(10, Math.floor(r.log10(t.max)))) : (t.minNotZero = 1));
											},
											buildTicks             : function() {
												var t = this,
													e = t.options.ticks,
													...
													o = (t.ticks = (function(t, e) {
														...
														0 === s
															? ((n = Math.floor(r.log10(e.minNotZero))), (i = Math.floor(e.minNotZero / Math.pow(10, n))), o.push(s), (s = i * Math.pow(10, n)))
															: ((n = Math.floor(r.log10(s))), (i = Math.floor(s / Math.pow(10, n))));
											...
											getPixelForValue       : function(e) {
												...
												return (
													...
													l.isHorizontal() ? ((n = l.width), (i = u ? l.right : l.left)) : ((n = l.height), (s *= -1), (i = u ? l.top : l.bottom)),
													e !== o &&
														(0 === o && ((n -= f = r.getValueOrDefault(l.options.ticks.fontSize, t.defaults.global.defaultFontSize)), (o = d)),
											...
											getValueForPixel       : function(e) {
												...
												if (
													...
													s.isHorizontal() ? ((n = s.width), (a = l ? s.right - e : e - s.left)) : ((n = s.height), (a = l ? e - s.top : s.bottom - e)),
													a !== i)
												) {
													if (0 === i) {
									...
									var p = t.LinearScaleBase.extend({
										...
										setReductions                 : function(t, e, n) {
											...
											(r = h(r)),
												...
												(o = h(o)),
												(a = h(a)),
												(this.drawingArea = Math.min(Math.round(t - (r + i) / 2), Math.round(t - (o + a) / 2))),
														...
														if (
															(r.display &&
																...
																(function(t, e, n, r) {
																	var o = t.ctx;
																	if (
																		((o.strokeStyle = i.valueAtIndexOrDefault(e.color, r - 1)),
																		(o.lineWidth = i.valueAtIndexOrDefault(e.lineWidth, r - 1)),
															...
															if (((u.font = m), u.save(), u.translate(t.xCenter, t.yCenter), u.rotate(h), o.showLabelBackdrop)) {
																...
																(u.fillStyle = o.backdropColor),
																	u.fillRect(-f / 2 - o.backdropPaddingX, -c - p / 2 - o.backdropPaddingY, f + 2 * o.backdropPaddingX, p + 2 * o.backdropPaddingY);
															}
							...
							function(t, e, n) {
								...
								function g(t, e) {
									...
									return 'function' == typeof n
										? n(t)
										: 'string' == typeof t && 'string' == typeof i ? r(t, i) : (t instanceof r || (t = r(t)), t.isValid() ? t : 'function' == typeof i ? i(t) : t);
								}
								...
								function y(t, e, n, i) {
									...
									for (
										h ||
											...
											a = r(y),
											g && f && !p && !s.round && (a.startOf(f), a.add(~~((y - a) / (v.size * h)) * h, l));
										a < b;
										a.add(h, l)
									)
										x.push(+a);
									...
									var t = a.extend({
										...
										determineDataLimits  : function() {
											...
											for (t = 0, n = (d.data.datasets || []).length; t < n; ++t)
												if (d.isDatasetVisible(t))
													if (((a = d.data.datasets[t].data), o.isObject(a[0]))) for (x[t] = [], e = 0, i = a.length; e < i; ++e) (s = v(a[e], c)), b.push(s), (x[t][e] = s);
													else b.push.apply(b, w), (x[t] = w.slice(0));
												else x[t] = [];
											w.length && ((w = h(w).sort(f)), (m = Math.min(m, w[0])), (y = Math.max(y, w[w.length - 1]))),
												b.length && ((b = h(b).sort(f)), (m = Math.min(m, b[0])), (y = Math.max(y, b[b.length - 1]))),
												(m = v(p.min, c) || m),
												(y = v(p.max, c) || y),
												(m = m === u ? +r().startOf(g) : m),
												(y = y === l ? +r().endOf(g) + 1 : y),
											...
											return (
												...
												(i._offsets = (function(t, e, n, r, i) {
													...
													return (
														i.offset &&
															e.length &&
															(i.time.min || ((o = e.length > 1 ? e[1] : r), (a = e[0]), (s = (p(t, 'time', o, 'pos') - p(t, 'time', a, 'pos')) / 2)),
															i.time.max ||
																((o = e[e.length - 1]), (a = e.length > 1 ? e[e.length - 2] : n), (l = (p(t, 'time', o, 'pos') - p(t, 'time', a, 'pos')) / 2))),
														{
															left  : s,
															right : l
														}
										...
										getLabelForIndex     : function(t, e) {
											...
											return (
												...
												r.tooltipFormat ? g(i, r).format(r.tooltipFormat) : 'string' == typeof i ? i : g(i, r).format(this._labelFormat)
											);
										},
	...
	function(t, e, n) {
         ...
         */
			(e = void 0),
				(r = function(t) {
					...
					function d(t, e) {
						...
						return (
									...
									for (var n, r, i, o = t.x0, d = t.y0, f = t.x1, h = t.y1, p = c(o, d, e), g = c(f, h, e); p | g && !(p & g); )
										(n = p || g) & u
											...
											: n & l
												...
												: n & s ? ((i = d + (h - d) * (e.right - o) / (f - o)), (r = e.right)) : n & a && ((i = d + (h - d) * (e.left - o) / (f - o)), (r = e.left)),
							...
							'start' === i ? ((n = o.x0), (r = o.y0)) : 'end' === i ? ((n = o.x1), (r = o.y1)) : ((n = (o.x0 + o.x1) / 2), (r = (o.y0 + o.y1) / 2)),
							(function(t, e, n, r, i) {
								switch (i) {
									case 'center':
										n = r = 0;
					...
					var f = {
							...
							rect     : function(t, e) {
								var n = i(t, e.origin),
									...
									s = 0;
								return (
									t.horizontal ? ((r = Math.min(t.x, t.base)), (a = Math.abs(t.base - t.x))) : ((o = Math.min(t.y, t.base)), (s = Math.abs(t.base - t.y))),
									d(
										{
											x0 : r,
											y0 : o + s,
					...
					h.extend(m.prototype, {
						_modelize : function(e, n, i, o) {
							...
							return {
								...
								a instanceof t.elements.Arc ? f.arc : a instanceof t.elements.Point ? f.point : a instanceof t.elements.Rectangle ? f.rect : f.fallback),
						...
						draw      : function(t, e) {
							...
							this.visible() &&
								(i.save(),
								o.clip && ((n = o.area), i.beginPath(), i.rect(n.left, n.top, n.right - n.left, n.bottom - n.top), i.clip()),
								...
								(function(t, e, n) {
									...
									(r || (i && o)) &&
										(t.beginPath(),
										h.canvas.roundedRect(t, p(e.x) + o / 2, p(e.y) + o / 2, p(e.w) - o, p(e.h) - o, n.borderRadius),
										t.closePath(),
							...
							formatter       : function(t) {
								...
								if (P.isObject(t))
									if (P.isNullOrUndef(t.label))
										if (P.isNullOrUndef(t.r)) for (i = '', r = 0, n = (e = Object.keys(t)).length; r < n; ++r) i += (0 !== r ? ', ' : '') + e[r] + ': ' + t[e[r]];
										else i = t.r;
									else i = t.label;
								return '' + i;
							},
					...
					var E = {
						...
						afterEvent         : function(e) {
							...
							for (n = 0, i = h.length; n < i; ++n)
								if ((s = h[n])[1]) for (o = 0, a = (u = s[0][I] || []).length; o < a; ++o) ((l = u[o]).$context.active = 1 === s[1]), l.update(l.$context);
							(c._dirty || h.length) &&
								(A.update(c._labels),
								(function(e) {
									if (!e.animating) {
				...
				'object' === ('undefined' == typeof exports ? 'undefined' : i(exports)) && void 0 !== t
					? (t.exports = r(n(160)))
					: 'function' == typeof define && n(55) ? define([ 'chart.js' ], r) : ((e = e || self).ChartDataLabels = r(e.Chart));
		}.call(this, n(87)(t)));
	},
	function(t, e, n) {
		'use strict';
				...
				easeOutBounce    : function(t, e, n, r, i) {
					return (e /= i) < 1 / 2.75
						...
						: e < 2 / 2.75
							...
							: e < 2.5 / 2.75 ? r * (7.5625 * (e -= 2.25 / 2.75) * e + 0.9375) + n : r * (7.5625 * (e -= 2.625 / 2.75) * e + 0.984375) + n;
				},
							...
							(n.isWindow = function(t) {
								...
								(n.extend = function() {
									var t,
										...
										d = !1;
									for (
										'boolean' == typeof l && ((d = l), (l = arguments[u] || {}), u++), 'object' != r(l) && 'function' !== n.type(l) && (l = {}), u === c && ((l = this), u--);
										c > u;
										u++
									)
												...
												(t = l[o]),
													l !== (i = a[o]) &&
														(d && i && (n.isPlainObject(i) || (e = n.isArray(i)))
															? (e ? ((e = !1), (s = t && n.isArray(t) ? t : [])) : (s = t && n.isPlainObject(t) ? t : {}), (l[o] = n.extend(d, s, i)))
															: void 0 !== i && (l[o] = i));
									return l;
								}),
									...
									g.isString(t)
										...
										: (n =
												g.isArray(t) && 1 === t.length
													? s.apply(null, t)
													: g.isArray(t) && 2 === t.length ? x.apply(null, t.concat([ e ])) : !(!g.isArray(t) || 4 !== t.length) && l.apply(null, t)),
										...
										if (b.State.calls[r]) {
											...
											for (var v = Math.min((e - u) / l.duration, 1), m = 0, y = s.length; y > m; m++) {
												...
												if (a(S)) {
													...
													l.visibility !== i && 'hidden' !== l.visibility && w.setPropertyValue(S, 'visibility', l.visibility),
													x))
														if ('element' !== M) {
															var A,
																P = x[M],
															...
															if (((P.currentValue = A), 'tween' === M)) p = A;
																...
																w.Hooks.registered[M] &&
																	(a(S).rootPropertyValueCache[I] = w.Normalizations.registered[I] ? w.Normalizations.registered[I]('extract', null, F[1]) : F[1]),
																	'transform' === F[0] && (C = !0);
															}
														}
													l.mobileHA && a(S).transformCache.translate3d === i && ((a(S).transformCache.translate3d = '(0px, 0px, 0px)'), (C = !0)),
														C && w.flushTransformCache(S);
												}
											}
											l.display !== i && 'none' !== l.display && (b.State.calls[r][2].display = !1),
												l.visibility !== i && 'hidden' !== l.visibility && (b.State.calls[r][2].visibility = !1),
												l.progress && l.progress.call(o[1], o[1], v, Math.max(0, u + l.duration - e), u, p),
												1 === v && d(r);
										}
								}
							...
							function d(t, e) {
								...
								for (var n = b.State.calls[t][0], r = b.State.calls[t][1], o = b.State.calls[t][2], s = b.State.calls[t][4], l = !1, u = 0, c = n.length; c > u; u++) {
									...
									if (
										(e ||
											o.loop ||
											('none' === o.display && w.setPropertyValue(d, 'display', o.display), 'hidden' === o.visibility && w.setPropertyValue(d, 'visibility', o.visibility)),
							...
							if (!(7 >= h)) {
								...
								var x = (function() {
									...
									return function t(e, r, i) {
										var o,
											...
											c = 0;
										for (
											e = parseFloat(e) || 500, r = parseFloat(r) || 20, i = i || null, l.tension = e, l.friction = r, a = (o = null !== i) ? (c = t(e, r)) / i * 0.016 : 0.016;
								...
								var w = (b.CSS = {
														...
														switch (t) {
															...
															case 'extract':
																...
																if (w.RegEx.wrappedValueAlreadyExtracted.test(r)) o = r;
																	...
																	/^[A-z]+$/i.test(r)
																		? (a = s[r] !== i ? s[r] : s.black)
																		: w.RegEx.isHex.test(r) ? (a = 'rgb(' + w.Values.hexToRgb(r).join(' ') + ')') : /^rgba?\(/i.test(r) || (a = s.black),
									...
									Values              : {
										...
										getUnitType    : function(t) {
											return /^(rotate|skew)/i.test(t)
												? 'deg'
												: /(^(scale|scaleX|scaleY|scaleZ|alpha|flexGrow|flexHeight|zIndex|fontWeight)$)|((opacity|red|green|blue|alpha)$)/i.test(t) ? '' : 'px';
										},
										getDisplayType : function(t) {
											...
											return /^(b|big|i|small|tt|abbr|acronym|cite|code|dfn|em|kbd|strong|samp|var|a|bdo|br|img|map|object|q|script|span|sub|sup|button|input|label|select|textarea)$/i.test(
												...
												? 'inline'
												: /^(li)$/i.test(e) ? 'list-item' : /^(tr)$/i.test(e) ? 'table-row' : /^(table)$/i.test(e) ? 'table' : /^(tbody)$/i.test(e) ? 'table-row-group' : 'block';
										},
									...
									getPropertyValue    : function(t, n, r, o) {
										function s(t, n) {
											...
											if (8 >= h) l = f.css(t, n);
												...
												var u,
													c = !1;
												if (
													(/^(width|height)$/.test(n) && 0 === w.getPropertyValue(t, 'display') && ((c = !0), w.setPropertyValue(t, 'display', w.Values.getDisplayType(t))), !o)
												) {
												...
												(u = a(t) === i ? e.getComputedStyle(t, null) : a(t).computedStyle ? a(t).computedStyle : (a(t).computedStyle = e.getComputedStyle(t, null))),
													'borderColor' === n && (n = 'borderTopColor'),
													('' === (l = 9 === h && 'filter' === n ? u.getPropertyValue(n) : u[n]) || null === l) && (l = t.style[n]),
													r();
											}
										...
										if (w.Hooks.registered[n]) {
											...
											r === i && (r = w.getPropertyValue(t, w.Names.prefixCheck(c)[0])),
												w.Normalizations.registered[c] && (r = w.Normalizations.registered[c]('extract', t, r)),
												(l = w.Hooks.extractValue(u, r));
										} else if (w.Normalizations.registered[n]) {
											var d, p;
											'transform' !== (d = w.Normalizations.registered[n]('name', t)) &&
												((p = s(t, w.Names.prefixCheck(d)[0])), w.Values.isCSSNullValue(p) && w.Hooks.templates[n] && (p = w.Hooks.templates[n][1])),
									...
									setPropertyValue    : function(t, n, r, i, o) {
										var s = n;
										if ('scroll' === n)
											o.container ? (o.container['scroll' + o.direction] = r) : 'Left' === o.direction ? e.scrollTo(r, o.alternateValue) : e.scrollTo(o.alternateValue, r);
										else if (w.Normalizations.registered[n] && 'transform' === w.Normalizations.registered[n]('name', t))
											w.Normalizations.registered[n]('inject', t, r), (s = 'transform'), (r = a(t).transformCache[n]);
										else {
											if (w.Hooks.registered[n]) {
												var l = n,
													u = w.Hooks.getRoot(n);
											...
											if (
												(w.Normalizations.registered[n] && ((r = w.Normalizations.registered[n]('inject', t, r)), (n = w.Normalizations.registered[n]('name', t))),
									...
									flushTransformCache : function(t) {
										...
										if ((h || (b.State.isAndroid && !b.State.isChrome)) && a(t).isSVG) {
											...
											f.each(a(t).transformCache, function(e) {
												return (
													(i = a(t).transformCache[e]), 'transformPerspective' === e ? ((o = i), !0) : (9 === h && 'rotateZ' === e && (e = 'rotate'), void (n += e + i + ' '))
												);
											}),
												o && (n = 'perspective' + o + ' ' + n);
										}
								...
								var S = function t() {
									...
									function s() {
										function t(t) {
											function d(t, e) {
												...
												return (
													g.isArray(t)
														? ((n = t[0]),
															(!g.isArray(t[1]) && /^[\d-]/.test(t[1])) || g.isFunction(t[1]) || w.RegEx.isHex.test(t[1])
																? (a = t[1])
																: ((g.isString(t[1]) && !w.RegEx.isHex.test(t[1])) || g.isArray(t[1])) && ((r = e ? t[1] : u(t[1], s.duration)), t[2] !== i && (a = t[2])))
														: (n = t),
													e || (r = r || s.easing),
											...
											function h(t, e) {
												var n, r;
												return (
													(r = (e || '0').toString().toLowerCase().replace(/[%A-z]+$/, function(t) {
														return (n = t), '';
													})),
											...
											function p() {
												...
												if (i && r) (l.emToPx = L.lastEmToPx), (l.percentToPxWidth = L.lastPercentToPxWidth), (l.percentToPxHeight = L.lastPercentToPxHeight);
													...
													b.init(u),
														...
														(l.percentToPxWidth = L.lastPercentToPxWidth = (parseFloat(w.getPropertyValue(u, 'width', null, !0)) || 1) / s),
														(l.percentToPxHeight = L.lastPercentToPxHeight = (parseFloat(w.getPropertyValue(u, 'height', null, !0)) || 1) / s),
														(l.emToPx = L.lastEmToPx = (parseFloat(w.getPropertyValue(u, 'paddingLeft')) || 1) / s),
											...
											if ('scroll' === P) {
												...
												s.container
													? g.isWrapped(s.container) || g.isNode(s.container)
														? ((s.container = s.container[0] || s.container), (M = (m = s.container['scroll' + A]) + f(o).position()[A.toLowerCase()] + T))
														: (s.container = null)
													: ((m = b.State.scrollAnchor[b.State['scrollProperty' + A]]),
														(S = b.State.scrollAnchor[b.State['scrollProperty' + ('Left' === A ? 'Top' : 'Left')]]),
												...
												for (var O in I)
													if ('element' !== O) {
														...
														(I[O].startValue = I[O].currentValue = I[O].endValue),
															...
															b.debug && console.log('reverse tweensContainer (' + O + '): ' + JSON.stringify(I[O]), o);
													}
												l = I;
											} else if ('start' === P) {
												for (var D in (a(o).tweensContainer && !0 === a(o).isAnimating && (I = a(o).tweensContainer),
												...
												y)) {
													...
													if (a(o).isSVG || 'tween' === B || !1 !== w.Names.prefixCheck(B)[1] || w.Normalizations.registered[B] !== i) {
														((s.display !== i && null !== s.display && 'none' !== s.display) || (s.visibility !== i && 'hidden' !== s.visibility)) &&
															/opacity|filter/.test(D) &&
															!z &&
															0 !== N &&
															(z = 0),
															s._cacheValues && I && I[D]
																? (z === i && (z = I[D].endValue + I[D].unitType), (W = a(o).rootPropertyValueCache[B]))
																: w.Hooks.registered[D]
																	? z === i ? ((W = w.getPropertyValue(o, B)), (z = w.getPropertyValue(o, D, W))) : (W = w.Hooks.templates[B][1])
														...
														if (
															...
															'%' === H &&
																(/^(fontSize|lineHeight)$/.test(D)
																	? ((N /= 100), (H = 'em'))
																	: /^scale/.test(D) ? ((N /= 100), (H = '')) : /(Red|Green|Blue)$/i.test(D) && ((N = N / 100 * 255), (H = ''))),
															/[\/*]/.test(U))
														)
															H = q;
														else if (q !== H && 0 !== z)
											...
											l.element &&
												...
												(a(o).isAnimating = !0),
												C === k - 1 ? (b.State.calls.push([ R, v, s, null, _.resolver ]), !1 === b.State.isTicking && ((b.State.isTicking = !0), c())) : C++);
										}
										var r,
											o = this,
										...
										!1 !== b.mock && (!0 === b.mock ? (s.duration = s.delay = 1) : ((s.duration *= parseFloat(b.mock) || 1), (s.delay *= parseFloat(b.mock) || 1))),
											...
											s.display !== i &&
												null !== s.display &&
												((s.display = s.display.toString().toLowerCase()), 'auto' === s.display && (s.display = b.CSS.Values.getDisplayType(o))),
									...
									if (
										(g.isWrapped(this) ? ((l = !1), (p = 0), (v = this), (h = this)) : ((l = !0), (p = 1), (v = S ? arguments[0].elements || arguments[0].e : arguments[0])),
										(v = o(v)))
									) {
										...
										if (!/^(stop|finish)$/i.test(y) && !f.isPlainObject(x)) {
											...
											for (var A = M; A < arguments.length; A++)
												g.isArray(arguments[A]) || (!/^(fast|normal|slow)$/i.test(arguments[A]) && !/^\d/.test(arguments[A]))
													? g.isString(arguments[A]) || g.isArray(arguments[A]) ? (x.easing = arguments[A]) : g.isFunction(arguments[A]) && (x.complete = arguments[A])
													...
													f.each(b.State.calls, function(t, e) {
														e &&
															f.each(e[1], function(n, r) {
																var o = x === i ? '' : x;
																return (
																	(!0 !== o && e[2].queue !== o && (x !== i || !1 !== e[2].queue)) ||
																	void f.each(v, function(n, i) {
																		i === r &&
																			((!0 === x || g.isString(x)) &&
																				(f.each(f.queue(i, g.isString(x) ? x : ''), function(t, e) {
																			...
																			'stop' === y
																				? (a(i) &&
																						a(i).tweensContainer &&
																						!1 !== o &&
																						f.each(a(i).tweensContainer, function(t, e) {
												...
												if (!f.isPlainObject(y) || g.isEmptyObject(y)) {
													if (g.isString(y) && b.Redirects[y]) {
														var I = (E = f.extend({}, x)).duration,
															O = E.delay || 0;
														return (
															!0 === E.backwards && (v = f.extend(!0, [], v).reverse()),
															f.each(v, function(t, e) {
																parseFloat(E.stagger) ? (E.delay = O + parseFloat(E.stagger) * t) : g.isFunction(E.stagger) && (E.delay = O + E.stagger.call(e, t, k)),
																	E.drag &&
																		((E.duration = parseFloat(I) || (/^(callout|transition)/.test(y) ? 1e3 : m)),
																		(E.duration = Math.max(E.duration * (E.backwards ? 1 - t / k : (t + 1) / k), 0.75 * E.duration, 200))),
																	b.Redirects[y].call(e, e, E || {}, t, k, v, _.promise ? _ : i);
															}),
															r()
														);
													}
										...
										if (
											...
											((E = f.extend({}, b.defaults, x)).loop = parseInt(E.loop)),
											(D = 2 * E.loop - 1),
											E.loop)
										)
											for (var N = 0; D > N; N++) {
	...
	function(t, e, n) {
		...
		var r = n(3),
			...
			$ = function(t, e, n) {
				return !(U(t, (e = g(e, !0))) && y(n) && v(n, 'value')) || v(n, 'get') || v(n, 'set') || n.configurable || (v(n, 'writable') && !n.writable) || (v(n, 'enumerable') && !n.enumerable)
					? I(t, e, n)
					: ((t[e] = n.value), t);
			};
		o
			...
			!(function(r, i) {
				...
				function a(t) {
					...
					return '[object String]' === i
						? n(t)
						: o(t) && /^\[object (Array|HTMLCollection|NodeList|Object)\]$/.test(i) && t.hasOwnProperty('length') ? t : o((e = t)) && e.nodeType > 0 ? [ t ] : [];
				}
				...
				var u = {
						...
						show     : function(t, e, n) {
							...
							var i = s(e),
								o = 0,
								a = 0;
							'touches' in t && t.touches.length ? ((o = t.touches[0].pageY - i.top), (a = t.touches[0].pageX - i.left)) : ((o = t.pageY - i.top), (a = t.pageX - i.left)),
								(a = a >= 0 ? a : 0),
								(o = o >= 0 ? o : 0);
						...
						hide     : function(t, e) {
							...
							i && (e.removeEventListener('touchend', u.hide), e.removeEventListener('touchcancel', u.hide)),
				...
				function h(t) {
					...
					if (null !== e) {
						...
						if ((f.registerEvent(t), 'touchstart' === t.type && u.delay)) {
							...
							u.show(t, e),
								i && (e.addEventListener('touchend', u.hide, !1), e.addEventListener('touchcancel', u.hide, !1)),
				...
				return (
					(t.init = function(t) {
						...
						'duration' in (t = t || {}) && (u.duration = t.duration),
							...
							i && (e.addEventListener('touchstart', h, !1), e.addEventListener('touchcancel', f.registerEvent, !1), e.addEventListener('touchend', f.registerEvent, !1)),
